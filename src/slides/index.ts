...
export const slides = [TitleSlide, BioSlide, TimelineSlide, IntroSlide, AgendaSlide, EngineerSectionSlide, VibeFlowSlide, ContextToolsSlide, DisclaimerSlide, BreakOutOfCodingSlide, ClaudeCodeSlide, UltimateExampleSlide, ImportantSlide, TeamSectionSlide, PovTeammatesSlide, AiCodeReviewSlide, StartHereSlide, AgentWorkflowSlide, TeachClaudeCommunicateSlide, AutoApproveHookSlide, WarcraftFunSlide, SkillMarketplaceSlide, WhatIsSkillSlide, MetaSkillsSlide, EverythingIsSkillSlide, SkillsActivatorSlide, AgentTracesSlide, SkillsInfrastructureSectionSlide, AgentsSectionSlide, OrgSectionSlide, AIInnovatorCurveSlide, IndustryPatternsSlide, ChallengeAssumptionsSlide, HumanAiEngSlide, FinalSlide];
